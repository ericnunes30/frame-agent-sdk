...
**`See`**
 ...
 - [PromptBuilderConfig](../interfaces/promptBuilder_promptBuilder_interface.PromptBuilderConfig.md) Para configuração completa
 - [PromptMode](../modules/promptBuilder_promptBuilder_interface.md#promptmode) Para modos disponíveis
...
- [buildTaskListPrompt](promptBuilder_promptBuilder.PromptBuilder.md#buildtasklistprompt)
- [buildToolSchemasByNames](promptBuilder_promptBuilder.PromptBuilder.md#buildtoolschemasbynames)
- [buildToolsPrompt](promptBuilder_promptBuilder.PromptBuilder.md#buildtoolsprompt)
- [determineSystemPrompt](promptBuilder_promptBuilder.PromptBuilder.md#determinesystemprompt)
...
▪ `Static` `Private` **promptModes**: `Map`\<`string`, (`config`: [`PromptBuilderConfig`](../interfaces/promptBuilder_promptBuilder_interface.PromptBuilderConfig.md)) => `string`\>
...
| `builder` | (`config`: [`PromptBuilderConfig`](../interfaces/promptBuilder_promptBuilder_interface.PromptBuilderConfig.md)) => `string` | Função construtora que retorna o texto específico do modo. Recebe a configuração completa e deve retornar as regras do modo. |
...
[buildSystemPrompt](promptBuilder_promptBuilder.PromptBuilder.md#buildsystemprompt) Para usar o modo registrado
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `config` | [`PromptBuilderConfig`](../interfaces/promptBuilder_promptBuilder_interface.PromptBuilderConfig.md) | Configuração completa do prompt builder. Deve incluir mode, agentInfo e pode incluir tools, instructions, etc. |
...
**`See`**
 ...
 - [addPromptMode](promptBuilder_promptBuilder.PromptBuilder.md#addpromptmode) Para registrar modos customizados
 - [buildToolSchemasByNames](promptBuilder_promptBuilder.PromptBuilder.md#buildtoolschemasbynames) Para conversão de tools
 - [PromptBuilderConfig](../interfaces/promptBuilder_promptBuilder_interface.PromptBuilderConfig.md) Para formato da configuração
...
[PromptBuilderConfig.taskList](../interfaces/promptBuilder_promptBuilder_interface.PromptBuilderConfig.md#tasklist) Para formato da task list
...
▸ **buildToolSchemasByNames**(`names`): [`ToolSchema`](../modules/promptBuilder_promptBuilder_interface.md#toolschema)[]
...
**`See`**
 ...
 - [toolRegistry](../modules/tools_core_toolRegistry.md#toolregistry) Para registro de tools
 - [generateTypedSchema](../modules/tools_constructor_schemaGenerator.md#generatetypedschema) Para geração de schemas
 - [buildSystemPrompt](promptBuilder_promptBuilder.PromptBuilder.md#buildsystemprompt) Para uso dos schemas gerados
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `tools?` | [`ToolSchema`](../modules/promptBuilder_promptBuilder_interface.md#toolschema)[] | Array de ToolSchema a serem incluídas no prompt. Se vazio ou undefined, retorna seção indicando ausência de tools. |
...
| `args.mode?` | `string` | - |
| `args.promptConfig?` | [`PromptBuilderConfig`](../interfaces/promptBuilder_promptBuilder_interface.PromptBuilderConfig.md) | - |
...
[buildSystemPrompt](promptBuilder_promptBuilder.PromptBuilder.md#buildsystemprompt) Para construção com configuração

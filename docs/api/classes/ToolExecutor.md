...
**`See`**
 ...
 - [IToolCall](../interfaces/IToolCall.md) Para formato de chamadas de ferramenta
 - [IToolResult](../interfaces/IToolResult.md) Para formato de resultados
...
- [constructor](ToolExecutor.md#constructor)

### Methods

- [execute](ToolExecutor.md#execute)

## Constructors

### constructor

• **new ToolExecutor**(): [`ToolExecutor`](ToolExecutor.md)
...
▸ **execute**(`toolCall`): `Promise`\<[`IToolResult`](../interfaces/IToolResult.md)\<`Record`\<`string`, `unknown`\>\>\>
...
| :------ | :------ | :------ |
| `toolCall` | [`IToolCall`](../interfaces/IToolCall.md) | Estrutura contendo o nome da ferramenta e parâmetros. Deve incluir toolName válido e params compatíveis com a ferramenta. |

#### Returns

`Promise`\<[`IToolResult`](../interfaces/IToolResult.md)\<`Record`\<`string`, `unknown`\>\>\>
...
**`See`**
 ...
 - [IToolCall](../interfaces/IToolCall.md) Para formato da chamada
 - [IToolResult](../interfaces/IToolResult.md) Para formato do resultado

#### Defined in

[src/tools/core/toolExecutor.ts:136](https://github.com/ericnunes30/frame-agent-sdk/blob/80882e3a1098ffccfeb4dd22eb10f4edeb4c782e/src/tools/core/toolExecutor.ts#L136)

...
**`See`**
 ...
 - [StepsConfig](../interfaces/StepsConfig.md) Para configuração do orquestrador
 - [Step](../interfaces/Step.md) Para definição de steps
 - [OrchestrationState](../interfaces/OrchestrationState.md) Para estado da orquestração

## Table of contents

### Constructors

- [constructor](StepsOrchestrator.md#constructor)

### Properties

- [config](StepsOrchestrator.md#config)
- [deps](StepsOrchestrator.md#deps)

### Methods

- [run](StepsOrchestrator.md#run)
- [runFlow](StepsOrchestrator.md#runflow)

## Constructors

### constructor

• **new StepsOrchestrator**(`deps`, `config`): [`StepsOrchestrator`](StepsOrchestrator.md)
...
| :------ | :------ | :------ |
| `deps` | [`StepsDeps`](../interfaces/StepsDeps.md) | Dependências necessárias (memory, llm, tools). |
| `config` | [`StepsConfig`](../interfaces/StepsConfig.md) | Configuração do orquestrador (mode, agentInfo, etc.). |

#### Returns

[`StepsOrchestrator`](StepsOrchestrator.md)
...
**`See`**
 ...
 - [StepsDeps](../interfaces/StepsDeps.md) Para dependências necessárias
 - [StepsConfig](../interfaces/StepsConfig.md) Para configuração disponível

#### Defined in

[src/orchestrators/steps/stepsOrchestrator.ts:94](https://github.com/ericnunes30/frame-agent-sdk/blob/80882e3a1098ffccfeb4dd22eb10f4edeb4c782e/src/orchestrators/steps/stepsOrchestrator.ts#L94)

## Properties

### config

• `Private` `Readonly` **config**: [`StepsConfig`](../interfaces/StepsConfig.md)

Configuração do orquestrador

#### Defined in

[src/orchestrators/steps/stepsOrchestrator.ts:75](https://github.com/ericnunes30/frame-agent-sdk/blob/80882e3a1098ffccfeb4dd22eb10f4edeb4c782e/src/orchestrators/steps/stepsOrchestrator.ts#L75)

___

### deps

• `Private` `Readonly` **deps**: [`StepsDeps`](../interfaces/StepsDeps.md)

Dependências necessárias para execução

#### Defined in

[src/orchestrators/steps/stepsOrchestrator.ts:73](https://github.com/ericnunes30/frame-agent-sdk/blob/80882e3a1098ffccfeb4dd22eb10f4edeb4c782e/src/orchestrators/steps/stepsOrchestrator.ts#L73)

## Methods

### run

▸ **run**(`steps`, `userInput`): `Promise`\<\{ `final`: `string` ; `state`: [`OrchestrationState`](../interfaces/OrchestrationState.md)  }\>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `steps` | [`Step`](../interfaces/Step.md)[] | Lista de steps a serem executados sequencialmente. |
| `userInput` | `string` | Input inicial do usuário para o fluxo. |

#### Returns

`Promise`\<\{ `final`: `string` ; `state`: [`OrchestrationState`](../interfaces/OrchestrationState.md)  }\>
...
**`See`**
 ...
 - [Step](../interfaces/Step.md) Para definição de steps
 - [StepContext](../interfaces/StepContext.md) Para contexto disponível nos steps
 - [OrchestrationState](../interfaces/OrchestrationState.md) Para estrutura do estado

#### Defined in

[src/orchestrators/steps/stepsOrchestrator.ts:171](https://github.com/ericnunes30/frame-agent-sdk/blob/80882e3a1098ffccfeb4dd22eb10f4edeb4c782e/src/orchestrators/steps/stepsOrchestrator.ts#L171)

___

### runFlow

▸ **runFlow**(`userInput`, `opts?`): `Promise`\<\{ `final`: `string` ; `pendingAskUser?`: \{ `details?`: `string` ; `question`: `string`  } ; `state`: [`OrchestrationState`](../interfaces/OrchestrationState.md)  }\>
...
`Promise`\<\{ `final`: `string` ; `pendingAskUser?`: \{ `details?`: `string` ; `question`: `string`  } ; `state`: [`OrchestrationState`](../interfaces/OrchestrationState.md)  }\>
...
**`See`**
 ...
 - [AGENT_MODES](../README.md#agent_modes) Para modos disponíveis (CHAT, REACT)
 - [PromptBuilder](PromptBuilder.md) Para construção de prompts do sistema
 - [ToolDetector](ToolDetector.md) Para detecção de SAP
 - [ToolExecutor](ToolExecutor.md) Para execução de ferramentas
 - [OrchestrationState](../interfaces/OrchestrationState.md) Para estrutura do estado retornado

#### Defined in

[src/orchestrators/steps/stepsOrchestrator.ts:293](https://github.com/ericnunes30/frame-agent-sdk/blob/80882e3a1098ffccfeb4dd22eb10f4edeb4c782e/src/orchestrators/steps/stepsOrchestrator.ts#L293)

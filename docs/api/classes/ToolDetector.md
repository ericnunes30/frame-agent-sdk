...
**`See`**
 ...
 - [IToolCall](../interfaces/IToolCall.md) Para formato das chamadas detectadas
 - [ISAPError](../interfaces/ISAPError.md) Para formato dos erros de detecção
 - [SAPParser](SAPParser.md) Para detalhes do parser subjacente

## Table of contents

### Constructors

- [constructor](ToolDetector.md#constructor)

### Methods

- [detect](ToolDetector.md#detect)

## Constructors

### constructor

• **new ToolDetector**(): [`ToolDetector`](ToolDetector.md)

#### Returns

[`ToolDetector`](ToolDetector.md)

## Methods

### detect

▸ **detect**(`llmOutput`): [`ToolDetectionResult`](../interfaces/ToolDetectionResult.md)
...
**`See`**
 ...
 - [ToolDetectionResult](../interfaces/ToolDetectionResult.md) Para formato do resultado
 - [IToolCall](../interfaces/IToolCall.md) Para formato das chamadas válidas

#### Defined in

[src/tools/core/toolDetector.ts:135](https://github.com/ericnunes30/frame-agent-sdk/blob/80882e3a1098ffccfeb4dd22eb10f4edeb4c782e/src/tools/core/toolDetector.ts#L135)

...
[agent/interfaces/AgentRegistry.interface](../modules/agent_interfaces_AgentRegistry_interface.md).IAgentRegistry
...
**`See`**
 ...
 - [AgentRegistryInfo](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md) Para informações de registro
 - [AgentRegistryStats](agent_interfaces_AgentRegistry_interface.AgentRegistryStats.md) Para estatísticas

## Implemented by

- [`AgentRegistry`](../classes/agent_registry_AgentRegistry.AgentRegistry.md)

## Table of contents

### Methods

- [clear](agent_interfaces_AgentRegistry_interface.IAgentRegistry.md#clear)
- [get](agent_interfaces_AgentRegistry_interface.IAgentRegistry.md#get)
- [getStats](agent_interfaces_AgentRegistry_interface.IAgentRegistry.md#getstats)
- [has](agent_interfaces_AgentRegistry_interface.IAgentRegistry.md#has)
- [list](agent_interfaces_AgentRegistry_interface.IAgentRegistry.md#list)
- [register](agent_interfaces_AgentRegistry_interface.IAgentRegistry.md#register)
- [unregister](agent_interfaces_AgentRegistry_interface.IAgentRegistry.md#unregister)
...
▸ **get**(`name`, `config?`): [`IAgent`](agent_interfaces_IAgent.IAgent.md)
...
| `config?` | `Partial`\<[`IAgentConfig`](agent_interfaces_IAgentConfig.IAgentConfig.md)\> | Configuração opcional para sobrescrever a padrão. Propriedades fornecidas substituem as da configuração padrão. |
...
▸ **getStats**(): [`AgentRegistryStats`](agent_interfaces_AgentRegistry_interface.AgentRegistryStats.md)
...
[`AgentRegistryStats`](agent_interfaces_AgentRegistry_interface.AgentRegistryStats.md)
...
[AgentRegistryStats](agent_interfaces_AgentRegistry_interface.AgentRegistryStats.md) Para formato das estatísticas
...
▸ **list**(): [`AgentRegistryInfo`](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md)[]
...
[`AgentRegistryInfo`](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md)[]
...
[AgentRegistryInfo](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md) Para formato das informações
...
| `agentClass` | (`config`: [`IAgentConfig`](agent_interfaces_IAgentConfig.IAgentConfig.md)) => [`IAgent`](agent_interfaces_IAgent.IAgent.md) | Classe construtora do agente. Deve implementar IAgent e aceitar IAgentConfig no construtor. |
| `config` | [`IAgentConfig`](agent_interfaces_IAgentConfig.IAgentConfig.md) | Configuração padrão do agente. Usada como base quando o agente é instanciado sem configurações customizadas. |
...
[AgentRegistrationOptions](agent_interfaces_AgentRegistry_interface.AgentRegistrationOptions.md) Para opções de registro

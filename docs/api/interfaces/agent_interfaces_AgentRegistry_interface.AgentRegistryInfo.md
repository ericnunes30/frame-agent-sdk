...
[agent/interfaces/AgentRegistry.interface](../modules/agent_interfaces_AgentRegistry_interface.md).AgentRegistryInfo
...
**`See`**
 ...
 - [IAgentRegistry](agent_interfaces_AgentRegistry_interface.IAgentRegistry.md) Para operações do registry
...
- [config](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md#config)
- [description](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md#description)
- [name](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md#name)
- [registeredAt](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md#registeredat)
- [type](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md#type)
- [usageCount](agent_interfaces_AgentRegistry_interface.AgentRegistryInfo.md#usagecount)

## Properties

### config

• **config**: [`IAgentConfig`](agent_interfaces_IAgentConfig.IAgentConfig.md)
...
[IAgentConfig](agent_interfaces_IAgentConfig.IAgentConfig.md) Para estrutura completa da configuração

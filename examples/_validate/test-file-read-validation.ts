...
import { FileReadTool } from '../../src/tools/tools/fileReadTool';
import { validateToolParams } from '../../src/tools/core/toolValidator';
...
async function main() {
  ...
  console.log('  parameterSchema === FileReadParams:', FileReadTool.parameterSchema === (require('../../src/tools/tools/fileReadTool') as any).FileReadParams);
  console.log('');
